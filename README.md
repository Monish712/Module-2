...
```
## Sample Output
![image](https://github.com/user-attachments/assets/e9ffd510-5d7c-4c75-b26c-db130ca363c3)
...
```
## Output
![image](https://github.com/user-attachments/assets/edadbdce-2200-4ce4-8576-67859d4abf04)
